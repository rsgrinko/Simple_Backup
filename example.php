<?php
require_once 'CBackup.class.php';
$CBackup = new CBackup($_SERVER['DOCUMENT_ROOT']); // создаем объект класса, передавая директорию в качестве аргумента
$CBackup->setOutputFolder($_SERVER['DOCUMENT_ROOT'].'/backup/backups'); // задаем директорию создания бекапа
